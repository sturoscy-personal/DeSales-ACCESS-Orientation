...
//plugins lates
 ...
 $('#jq-secondaryNavigation .jq-allPlugins').addClass('jq-current');
		...
		//home snippet
				...
				$('.jq-runCode2').click(function(){
					
						eval($(this).parent().find('code').text());
					 $(foo32).css("background-image","url(images/si.jpg)");
		 	...
		 	if (	$("input[@name='RadioGroup2']:checked").val() == 1  )
		{
			  
					 
			  $(foo12).css("background-image","url(images/no.jpg)");
			
         
        return true;
      }
	   	if (	$("input[@name='RadioGroup2']:checked").val() == 2 )
		{
			  
					 
			  $(foo22).css("background-image","url(images/no.jpg)");
			
         
        return true;
      }
	  
	   	if (	$("input[@name='RadioGroup2']:checked").val() == 4  )
		{
			  
					 
			  $(foo42).css("background-image","url(images/no.jpg)");
...
// -------------	
				...
				$('.jq-runCode3').click(function(){
					
					eval($(this).parent().find('code').text());
					
					 $(foo13).css("background-image","url(images/si.jpg)");
						 $(this).hide();
			 
		 
		 
		  	if (	$("input[@name='RadioGroup3']:checked").val() == 2  )
		{
			  
					 
			  $(foo23).css("background-image","url(images/no.jpg)");
...
// -------------		
		...
		$('.jq-runCode').click(function(){
			eval($(this).parent().find('code').text());
		 $(foo2).css("background-image","url(images/si.jpg)");
		 	...
		 	if (	$("input[@name='RadioGroup1']:checked").val() == 1  )
		{
			  ...
			  $(foo1).css("background-image","url(images/no.jpg)");
			      
        return true;
      }
	   	if (	$("input[@name='RadioGroup1']:checked").val() == 3 )
		{
			  
					 
			  $(foo3).css("background-image","url(images/no.jpg)");
			    
        return true;
      }
	  
	   	if (	$("input[@name='RadioGroup1']:checked").val() == 4  )
		{
			  
					 
			  $(foo4).css("background-image","url(images/no.jpg)");			
...
//----------
		...
		$('.jq-runCode4').click(function(){
			eval($(this).parent().find('code').text());
		 $(foo24).css("background-image","url(images/si.jpg)");
		 
		 $(this).hide();
			 
		 	 
		 
		 	if (	$("input[@name='RadioGroup4']:checked").val() == 1  )
		{
			  
					 
			  $(foo14).css("background-image","url(images/no.jpg)");
...
//----------
		...
		$('.jq-runCode5').click(function(){
					
						eval($(this).parent().find('code').text());
					 $(foo55).css("background-image","url(images/si.jpg)");
		 	...
		 	if (	$("input[@name='RadioGroup5']:checked").val() == 1  )
		{
			  
					 
			  $(foo15).css("background-image","url(images/no.jpg)");
			
         
        return true;
      }
	   	if (	$("input[@name='RadioGroup5']:checked").val() == 2 )
		{
			  
					 
			  $(foo25).css("background-image","url(images/no.jpg)");
			
         
        return true;
      }
	  
	   	if (	$("input[@name='RadioGroup5']:checked").val() == 3  )
		{
			  
					 
			  $(foo35).css("background-image","url(images/no.jpg)");
			
         
        return true;
      }
		if (	$("input[@name='RadioGroup5']:checked").val() == 4  )
		{
			  
					 
			  $(foo45).css("background-image","url(images/no.jpg)");
...
// -------------
		...
		$('.jq-runCode6').click(function(){
			eval($(this).parent().find('code').text());
		 $(foo26).css("background-image","url(images/si.jpg)");
		 
		 $(this).hide();
			 
		 	 
		 
		 	if (	$("input[@name='RadioGroup6']:checked").val() == 1  )
		{
			  
					 
			  $(foo16).css("background-image","url(images/no.jpg)");
...
//----------	
		...
		$('.jq-runCode7').click(function(){
			eval($(this).parent().find('code').text());
		 $(foo27).css("background-image","url(images/si.jpg)");
		 
		 $(this).hide();
			 
		 	 
		 
		 	if (	$("input[@name='RadioGroup7']:checked").val() == 1  )
		{
			  
					 
			  $(foo17).css("background-image","url(images/no.jpg)");
...
//----------	
		...
		$('.jq-runCode8').click(function(){
			eval($(this).parent().find('code').text());
		 $(foo18).css("background-image","url(images/si.jpg)");
		 
		 $(this).hide();
			 
		 	 
		 
		 	if (	$("input[@name='RadioGroup8']:checked").val() == 2  )
		{
			  
					 
			  $(foo28).css("background-image","url(images/no.jpg)");
...
//----------	
		...
		$('.jq-runCode9').click(function(){
					
						eval($(this).parent().find('code').text());
					 $(foo59).css("background-image","url(images/si.jpg)");
		 	...
		 	if (	$("input[@name='RadioGroup9']:checked").val() == 1  )
		{
			  
					 
			  $(foo19).css("background-image","url(images/no.jpg)");
			
         
        return true;
      }
	   	if (	$("input[@name='RadioGroup9']:checked").val() == 2 )
		{
			  
					 
			  $(foo29).css("background-image","url(images/no.jpg)");
			
         
        return true;
      }
	  
	   	if (	$("input[@name='RadioGroup9']:checked").val() == 3  )
		{
			  
					 
			  $(foo39).css("background-image","url(images/no.jpg)");
			
         
        return true;
      }
		if (	$("input[@name='RadioGroup9']:checked").val() == 4  )
		{
			  
					 
			  $(foo49).css("background-image","url(images/no.jpg)");
...
// -------------
		...
		$('.jq-runCode10').click(function(){
					
						eval($(this).parent().find('code').text());
					 $(foo510).css("background-image","url(images/si.jpg)");
		 	...
		 	if (	$("input[@name='RadioGroup10']:checked").val() == 1  )
		{
			  
					 
			  $(foo110).css("background-image","url(images/no.jpg)");
			
         
        return true;
      }
	   	if (	$("input[@name='RadioGroup10']:checked").val() == 2 )
		{
			  
					 
			  $(foo210).css("background-image","url(images/no.jpg)");
			
         
        return true;
      }
	  
	   	if (	$("input[@name='RadioGroup10']:checked").val() == 3  )
		{
			  
					 
			  $(foo310).css("background-image","url(images/no.jpg)");
			
         
        return true;
      }
		if (	$("input[@name='RadioGroup10']:checked").val() == 4  )
		{
			  
					 
			  $(foo410).css("background-image","url(images/no.jpg)");
...
// -------------
		...
		$('.jq-runCode11').click(function(){
			eval($(this).parent().find('code').text());
		 $(foo111).css("background-image","url(images/si.jpg)");
		 
		 $(this).hide();
			 
		 	 
		 
		 	if (	$("input[@name='RadioGroup11']:checked").val() == 2  )
		{
			  
					 
			  $(foo211).css("background-image","url(images/no.jpg)");
...
//----------	
		...
		$('.jq-runCode12').click(function(){
					
						eval($(this).parent().find('code').text());
					 $(foo412).css("background-image","url(images/si.jpg)");
		 	...
		 	if (	$("input[@name='RadioGroup12']:checked").val() == 1  )
		{
			  
					 
			  $(foo112).css("background-image","url(images/no.jpg)");
			
         
        return true;
      }
	   	if (	$("input[@name='RadioGroup12']:checked").val() == 2 )
		{
			  
					 
			  $(foo212).css("background-image","url(images/no.jpg)");
			
         
        return true;
      }
	  
	   	if (	$("input[@name='RadioGroup12']:checked").val() == 3  )
		{
			  
					 
			  $(foo312).css("background-image","url(images/no.jpg)");
			
         
        return true;
      }
		if (	$("input[@name='RadioGroup12']:checked").val() == 5  )
		{
			  
					 
			  $(foo512).css("background-image","url(images/no.jpg)");
...
// -------------
		...
		$('.jq-runCode13').click(function(){
					
						eval($(this).parent().find('code').text());
					 $(foo113).css("background-image","url(images/si.jpg)");
		 	...
		 	if (	$("input[@name='RadioGroup13']:checked").val() == 4  )
		{
			  
					 
			  $(foo413).css("background-image","url(images/no.jpg)");
			
         
        return true;
      }
	   	if (	$("input[@name='RadioGroup13']:checked").val() == 2 )
		{
			  
					 
			  $(foo213).css("background-image","url(images/no.jpg)");
			
         
        return true;
      }
	  
	   	if (	$("input[@name='RadioGroup13']:checked").val() == 3  )
		{
			  
					 
			  $(foo313).css("background-image","url(images/no.jpg)");
			
         
        return true;
      }
		if (	$("input[@name='RadioGroup13']:checked").val() == 5  )
		{
			  
					 
			  $(foo513).css("background-image","url(images/no.jpg)");
...
// -------------
		...
		$('.jq-runCode14').click(function(){
			eval($(this).parent().find('code').text());
		 $(foo214).css("background-image","url(images/si.jpg)");
		 
		 $(this).hide();
			 
		 	 
		 
		 	if (	$("input[@name='RadioGroup14']:checked").val() == 1  )
		{
			  
					 
			  $(foo114).css("background-image","url(images/no.jpg)");
...
//----------	
		...
		$('.jq-runCode15').click(function(){
			eval($(this).parent().find('code').text());
		 $(foo115).css("background-image","url(images/si.jpg)");
		 
		 $(this).hide();
			 
		 	 
		 
		 	if (	$("input[@name='RadioGroup15']:checked").val() == 2  )
		{
			  
					 
			  $(foo215).css("background-image","url(images/no.jpg)");
